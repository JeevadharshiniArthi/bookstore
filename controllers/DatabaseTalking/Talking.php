...
class Talking
{
    protected $conn;
    protected $stat;
    private static $userName = 'epiz_33971029';
    private static $pass = 'poMonLGzPz1';
    private static $dbname = 'epiz_33971029_thebookworld';
    private static $host = 'sql305.epizy.com ';
